...
if __name__ == "__main__":
    ...
    if flagm0:
	tuneshift_most,tuneshiftnx,tuneshiftm0,eigenvectors=eigenmodesDELPHI_converged_scan(Qpscan,nxscan,dampscan,Nbscan,
	...
	tuneshift_most,tuneshiftnx,eigenvectors=eigenmodesDELPHI_converged_scan(Qpscan,nxscan,dampscan,Nbscan,
    	    omegasscan,dphasescan,M,omega0,Q,gamma,eta,a,b,taub,g,Z,freq,
	    particle=particle,flagnorm=flagnorm,flag_trapz=flag_trapz,
	    flagdamperimp=flagdamperimp,d=d,freqd=d,kmax=kmax,kmaxplot=kmaxplot,
	    crit=crit,abseps=abseps,flagm0=flagm0,flageigenvect=flageigenvect)
    ...
    pick.dump(eigenvectors,fileall);
