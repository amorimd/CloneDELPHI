...
if __name__ == "__main__":
    ...
    kmaxplot=15; # number of plotted eigenvalues
	...
	for imodel,model in enumerate(models):
		...
		for idamp,damp in enumerate(dampscan):
			...
			fileoutplotQp=path_here+'../../../DELPHI_results/'+machine+root_result+'/plot_vs_Qp_'+machine+'_'+float_to_str(round(E/1e9))+'GeV'+model+'_'+str(M)+'b_d'+float_to_str(damp)+'_Nb'+float_to_str(Nb/1.e11)+'e11_converged'+strnorm[flagnorm]+'_'+plane;
			# output file name for data vs Qp
			fileoutdataQp=path_here+'../../../DELPHI_results/'+machine+root_result+'/data_vs_Qp_'+machine+'_'+float_to_str(round(E/1e9))+'GeV'+model+'_'+str(M)+'b_d'+float_to_str(damp)+'_Nb'+float_to_str(Nb/1.e11)+'e11_converged'+strnorm[flagnorm]+'_'+plane;
