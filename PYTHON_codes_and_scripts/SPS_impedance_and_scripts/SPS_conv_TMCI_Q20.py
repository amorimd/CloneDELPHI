...
if __name__ == "__main__":
    ...
    # fixed parameters
    machine,E,gamma,sigmaz,taub,R,Qx,Qxfrac,Qy,Qyfrac,Qs,eta,f0,omega0,omegas,dphase,Estr=SPS_param(E0,E=26e9,optics='Q20');
    beta=np.sqrt(1.-1./(gamma**2))
    # parameters for Hannes test
    sigmaz=0.16; # not from Hannes input file (unmatched) but obtained by HEADTAIL after stabilization
    ...
    # scan definition
    scenarioscan=['_SPS_Q20_2012_full_modifNico'];
    legscen=['Q20, full model'];
