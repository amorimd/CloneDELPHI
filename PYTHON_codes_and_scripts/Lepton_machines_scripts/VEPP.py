...
if __name__ == "__main__":
	...
	if (Qpx==0):
	    ...
	    # output file name
	    fileout='../DELPHI_results/plot_TMCI_DELPHI_vs_Karliner-Popov_'+machine+'_'+float_to_str(round(E/1e8)/10)+'GeV'+model+'_'+str(M)+'b_f'+float_to_str(fdamp)+'_'+str(nmax+1)+'radialmodes_maxazim'+str(lmax)+'_Qp'+float_to_str(Qpx)+strfreqflag[flagdamperimp]+strnorm[flagnorm];
